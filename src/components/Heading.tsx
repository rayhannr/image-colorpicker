...
const Heading: React.FC = () => (
    <>
        ...
        <h3 className="text-center text-sm xl:text-base text-gray-400 mt-1 mb-5 mx-auto w-full md:w-10/12">
            Upload an image from your device, click any pixel on the image to get its color once it gets loaded. <br /> We also show you the closest <a className="text-light-blue-600 font-medium hover:text-gray-700" href="https://tailwindcss.com/docs/customizing-colors" target="_blank" rel="noreferrer">Tailwind color</a> of your picked color.
        </h3>
    </>
)

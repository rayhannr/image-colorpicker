...
const Heading: React.FC = () => (
    <>
        ...
        <h3 className="text-center text-sm xl:text-base text-gray-400 mt-1 mb-5 mx-auto w-full md:w-10/12 lg:w-8/12 xl:w-1/2">
            Upload an image from your device, click any pixel on the image to get its color and the closest <a className="text-light-blue-600 font-medium hover:text-gray-700" href="https://tailwindcss.com/docs/customizing-colors" target="_blank" rel="noreferrer">Tailwind color</a> once it gets loaded.
        </h3>
    </>
)
